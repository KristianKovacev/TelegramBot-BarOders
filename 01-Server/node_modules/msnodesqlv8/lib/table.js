...
const tableModule = (() => {
  class TableMgr {
    constructor (connection, connectionMeta, connectionUser) {
      const cache = {}
  ...
  class Meta {
    ...
    // filter out duplicate columns with the same name
      ...
      function columnSet (colSubSet, operator) {
      ...
      this.getInsertSignature = getInsertSignature
      this.getSelectSignature = getSelectSignature
      this.getDeleteSignature = getDeleteSignature
      this.getUpdateSignature = getUpdateSignature
      this.getColumnsByName = getColumnsByName
      this.getWhereColumns = getWhereColumns
      this.getUpdateColumns = getUpdateColumns
      this.getPrimaryColumns = getPrimaryColumns
      this.getAssignableColumns = getAssignableColumns
    }
  }
